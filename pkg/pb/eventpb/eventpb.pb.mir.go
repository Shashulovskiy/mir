...
func (*Event) ReflectTypeOptions() []reflect.Type {
	return []reflect.Type{
		...
		reflect.TypeOf((*Event_Brbencoded)(nil)),
		reflect.TypeOf((*Event_Brbct)(nil)),
		reflect.TypeOf((*Event_MerkelBuildRequest)(nil)),
		reflect.TypeOf((*Event_MerkelBuildResult)(nil)),
		reflect.TypeOf((*Event_MerkelVerifyRequest)(nil)),
		reflect.TypeOf((*Event_MerkelVerifyResult)(nil)),
		reflect.TypeOf((*Event_DataEncodeRequest)(nil)),
...
func (*SigVerOrigin) ReflectTypeOptions() []reflect.Type {
	return []reflect.Type{
		...
		reflect.TypeOf((*SigVerOrigin_Iss)(nil)),
