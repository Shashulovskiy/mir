...
template<uint32_t f>
std::vector<uint8_t> encode(ezpwd::RS<31, 31 - 2 * f> &coder, std::vector<uint8_t> &data) {
    coder.encode(data);
...
template<uint32_t f>
std::vector<uint8_t> decode(ezpwd::RS<31, 31 - 2 * f> &coder, std::vector<uint8_t> &data, std::vector<int> &missing) {
...
ezpwd::RS<31, 31 - 2 * 1> coder1;
ezpwd::RS<31, 31 - 2 * 2> coder2;
ezpwd::RS<31, 31 - 2 * 3> coder3;
ezpwd::RS<31, 31 - 2 * 4> coder4;
ezpwd::RS<31, 31 - 2 * 5> coder5;
ezpwd::RS<31, 31 - 2 * 6> coder6;
ezpwd::RS<31, 31 - 2 * 7> coder7;
ezpwd::RS<31, 31 - 2 * 8> coder8;
ezpwd::RS<31, 31 - 2 * 9> coder9;
ezpwd::RS<31, 31 - 2 * 10> coder10;
//ezpwd::RS<31, 31 - 2 * 11> coder11;
//ezpwd::RS<31, 31 - 2 * 12> coder12;
//ezpwd::RS<31, 31 - 2 * 13> coder13;
//ezpwd::RS<31, 31 - 2 * 14> coder14;
//ezpwd::RS<31, 31 - 2 * 15> coder15;
//ezpwd::RS<31, 31 - 2 * 16> coder16;
//ezpwd::RS<31, 31 - 2 * 17> coder17;
//ezpwd::RS<31, 31 - 2 * 18> coder18;
//ezpwd::RS<31, 31 - 2 * 19> coder19;
//ezpwd::RS<31, 31 - 2 * 20> coder20;
